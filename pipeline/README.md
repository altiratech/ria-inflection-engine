...
- `score.py` for rubric scoring, subsection-aware excerpt selection, rationale packaging, low-value evidence filtering for generic review/reimbursement/platform/risk/support boilerplate, and explainability-aware evidence-slot selection
