...
- `score.py` for rubric scoring, subsection-aware excerpt selection, rationale packaging, and low-value evidence filtering for generic review/reimbursement/platform/risk/support boilerplate
