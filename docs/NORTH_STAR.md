# RIA Inflection Engine North Star

Status: long-term ambition document
...
- Natural expansion: `ria_operating_stress_os`
- Dangerous expansion: full compliance operating system before the core ranked loop is trusted
- What must remain true: evidence-first, filing-grounded, explainable
...
- Standalone or suite module: standalone first, potentially suite-compatible later
- What should be shared: identity, shared infra, design quality bar
- What should stay product-specific: ontology, workflows, score logic
